...
public class Class {
    ...
    private static String username = "Irfan Pramono Aryosetyo";
    private static int pin = 767676;
    ...
    public static void main(String[] args) {
        ...
        if (authenticate(inputUsername, inputPin)) {
            ...
            while (isRunning) {
                System.out.println("BANK INSYAALLAH BERKAH");
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        System.out.println("----BANK INSYALLAH BERKAH-----");
                        break;
                    default:
